...
public class UniversityController {
    private final ru.mirea.Practice_24.service.UniversityServiceImpl universityService;

    public UniversityController(ru.mirea.Practice_24.service.UniversityServiceImpl universityService) {
